  ...
  return (
    ...
    <Alert alert={alert} />
      <Routes>
        ...
        <Route path="/display" element={<DisplayStudent showAlert={showAlert} students={students} />}/>
        {/* <Route path="/edit/:id" element={<EditStudent students={students} showAlert={showAlert} setStudents={setStudents}/>} /> */}
        {/* <Route path="/edit" element={<EditStudentApi students={students} showAlert={showAlert} setStudents={setStudents}/>} /> */}
